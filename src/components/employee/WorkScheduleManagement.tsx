                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600">Thời gian mặc định</span>
                    </div>
                  </div>
                               ...
                               <div className="flex flex-col items-center gap-1">
                                 ...
                                 <div className="flex flex-col items-center gap-1">
                                   ...
                                   {daySchedule.workType !== 'off' && daySchedule.startTime && daySchedule.endTime && (
                                     <div className="flex flex-col items-center gap-1">
                                       {/* Default Schedule Time (Gray) */}
                                       <div className="text-xs text-gray-400 font-mono flex items-center gap-1">
                                         <div className="w-2 h-2 rounded-full bg-gray-400"></div>
                                         {daySchedule.startTime}-{daySchedule.endTime}
                                       </div>
                                       
                                       {/* Actual Work Time (Green) - Same as default for now, but can be different if there are breaks */}
                                       {(() => {
                                         // Calculate actual work time (subtract breaks if any)
                                         const actualStart = daySchedule.startTime;
                                         const actualEnd = daySchedule.endTime;
                                         const workHours = getWorkDuration(daySchedule.startTime, daySchedule.endTime);
                                   ...
                                   {/* Time for Off days with specific hours */}
                                   {daySchedule.workType === 'off' && daySchedule.startTime && daySchedule.endTime && (
